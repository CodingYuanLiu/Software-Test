...
> 对应代码文件为Action-Login and Browse from Index.c
...
> 对应代码文件为Action-Register and Login.c
...
2. 当Vuser最大为4的时候：
   ...
   ![](catalogImages/2020_07_05_17_46.jpeg)

   ![](catalogImages/2020_07_05_17_47.jpeg)
...
> 对应代码文件为Action-Login, Browse and Order.c
...
2. 修改 *Virtual User Generator* 生成的脚本
   ...
   1. 将 *username* 参数化，这里需要使用 *vuerid* 的参数化配置，因为如果不同的 *vuser* 使用了同一个用户登录，进行下单操作，可能会造成并发问题。
      ...
      <img src="测试报告.assets\image-20200705231716649.png" alt="image-20200705231716649" style="zoom:50%;" />
...
4. 使用 *Analysis* 对结果进行分析，设置SLA —— 用户数小于 20 时，每个事务的响应时间在 0.5s 以内；用户数介于 20 - 40 之间时，每个事务的响应时间在2s 以内；用户数大于40时，响应时间在 8s 以内。
   ...
   <img src="测试报告.assets\image-20200705233348995.png" alt="image-20200705233348995" style="zoom: 67%;" />

   上图为 SLA 评测结果，50个vuser的情况下，性能比较正常

5. 使用 Analysis 对 TX 和 Running User 进行关联分析

<img src="测试报告.assets\image-20200705233731784.png" alt="image-20200705233731784" style="zoom:67%;" />

<div align="center"><small>图：TPS</small></div>

随着用户的上升，TPS 是呈上升趋势的。

<img src="测试报告.assets\image-20200705233641267.png" alt="image-20200705233641267" style="zoom:67%;" />
...
我们首先分析一下 TPS	<img src="测试报告.assets\image-20200705234103582.png" alt="image-20200705234103582" style="zoom:67%;" />
...
<img src="测试报告.assets\image-20200705233954813.png" alt="image-20200705233954813" style="zoom:80%;" />
...
<img src="测试报告.assets\TIMEOUT.png" alt="TIMEOUT" style="zoom:80%;" />
...
<img src="测试报告.assets\新架构.png" alt="新架构" style="zoom: 33%;" />
